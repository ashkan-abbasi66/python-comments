...
def copy_valid_files(input_dir, output_dir, log_file, formatter="%d"):
    """
                    ...
                    if not pil_img.mode.lower() == "rgb" or \
                        ...
                        if np_img.var() == 0:
                            ...
                            if pil_img in copied_files:
                                ...
                                try:
                                    new_name = formatter % num_valid + '.jpg'
                                except:
                                    print('ERROR: formatter is incorrect. Use a valid Python formatter. E.g., %.6d')
                                    return
...
log_file = ""
formatter="%d"
num_valid = copy_valid_files(input_dir, output_dir, log_file, formatter)
